...
class Fruit16:
    ...
    def calc(self, year=None, month=None, day=None, hour=None):
        ...
        if year is None:
            year = dt.year
        # TODO получить лунный месяц
        if month is None:
            month = dt.month
        else:
            month -=1
        # TODO получить лунный день
        if day is None:
            day = dt.day
        else:
            day -=1
